const __vite__mapDeps = (i, m = __vite__mapDeps, d = m.f ||= ["assets/index.umd-CoBP2sDX.js", "assets/index-BVS4T5_D.js"]) => i.map(i => d[i]);
...
function s(s) {
  return t(this, undefined, undefined, function () {
    ...
    return i(this, function (i) {
      switch (i.label) {
        case 0:
          return [4, r(() => import("./index.umd-CoBP2sDX.js").then(r => r.i), __vite__mapDeps([0, 1]))];
        case 1:
          t = i.sent();
          s._plugins = t;
          return [2];
