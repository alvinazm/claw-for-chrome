(function () {
  (function () {
    ...
    function d() {
      ...
      if (t) {
        ...
        t = function () {
          ...
          const t = e.querySelector("#claude-static-chat-tooltip");
          if (n) {
            n.addEventListener("mouseenter", () => {
          ...
          const a = e.querySelector("#claude-static-close-tooltip");
          if (i) {
    ...
    chrome.runtime.onMessage.addListener((l, u, y) => {
      if (l.type === "SHOW_AGENT_INDICATORS") {
        r = r || l.isMcp === true;
        p();
        y({
          success: true
        });
      } else if (l.type === "HIDE_AGENT_INDICATORS") {
        c();
        y({
          success: true
        });
      } else if (l.type === "HIDE_FOR_TOOL_USE") {
        s = i;
        o = a;
        if (e) {
      ...
      } else if (l.type === "SHOW_AFTER_TOOL_USE") {
        if (s) {
          if (e) {
            e.style.display = "";
          }
      ...
      } else if (l.type === "SHOW_STATIC_INDICATOR") {
        d();
        y({
          success: true
        });
      } else if (l.type === "HIDE_STATIC_INDICATOR") {
        L();
        y({
          success: true
        });
