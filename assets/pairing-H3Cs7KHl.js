...
function m() {
  ...
  const r = e.get("request_id") || "";
  const s = e.get("client_type") || "desktop";
  const m = e.get("current_name") || undefined;
  return t.jsx("div", {
...
e.createRoot(document.getElementById("root")).render(t.jsx(s.StrictMode, {
  children: t.jsx(r, {
    children: t.jsx(m, {})
  })
}));